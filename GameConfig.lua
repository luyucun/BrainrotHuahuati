...
GameConfig.PROGRESS = {
	PlayerAttributeName = "ProgressLevel",
	UpdateIntervalSeconds = 0.25,
	LandRootFolderName = "Land",
	FloatLandFolderPrefix = "FloatLand",
	FloatLandCount = 9,
	FloatLandPartName = "Land",
	FloatLandBoundsPaddingXZ = 18,
	FloatLandBoundsPaddingY = 180,
	HomeBoundsPaddingXZ = 18,
	HomeBoundsPaddingY = 40,
	IconSpacingScale = 0.72,
}
...
GameConfig.SHOP = {
	...
	PurchaseSyncRetrySeconds = 0.8,
	PurchaseSyncMaxAttempts = 8,
	ServerLuckyNodeNames = { "Lukcy" },
	ServerLuckyProductId = 3572220012,
	ServerLuckyPriceRobux = 59,
	ServerLuckyDurationSeconds = 300,
	ServerLuckyExpireAtAttributeName = "ServerLuckyExpireAt",
	ServerLuckyLastBuyerNameAttributeName = "ServerLuckyLastBuyerName",
	ServerLuckyPurchaseSerialAttributeName = "ServerLuckyPurchaseSerial",
	ServerLuckyTipTemplate = "[%s] increased the server's luck！",
	ServerLuckyCountdownUpdateInterval = 0.25,
	ServerLuckyTipDisplaySeconds = 2,
	ServerLuckyTipEnterOffsetY = 40,
	ServerLuckyTipFadeOffsetY = -8,
	ServerLuckyTipFadeInSeconds = 0.25,
	ServerLuckyTipFadeOutSeconds = 0.35,
	LuckyBlockBundleNodeName = "LukcyBlock",
	LuckyBlockIconFloatOffsetPx = 12,
	LuckyBlockIconFloatDurationSeconds = 1.15,
	LuckyBlockLightRotateDurationSeconds = 3.8,
	LuckyBlockBundleOffers = {
		BuyButton1 = {
			ButtonName = "BuyButton1",
			ProductId = 3572362716,
			BlockId = 1001,
			Quantity = 1,
		},
		BuyButton2 = {
			ButtonName = "BuyButton2",
			ProductId = 3572363001,
			BlockId = 1001,
			Quantity = 3,
		},
		BuyButton3 = {
			ButtonName = "BuyButton3",
			ProductId = 3572363207,
			BlockId = 1001,
			Quantity = 10,
		},
	},
	VipGamePassId = 1789946187,
	VipPriceRobux = 139,
	VipOwnedAttributeName = "VipOwned",
	VipProductionBonusAttributeName = "VipProductionBonusRate",
	VipProductionBonusRate = 1,
	VipOwnedText = "Owned",
	VipPromptingText = "...",
	VipTagColor = "#FFC93C",
	VipIconTemplateName = "VipIcon",
	VipIconInstanceName = "VipIcon",
	VipIconStudsOffsetWorldSpace = Vector3.new(0, 3.25, 0),
	CashOffers = {
		Cash1 = {
			NodeName = "Cash1",
			ProductId = 3572204402,
			PriceRobux = 9,
			CoinAmount = 5000,
		},
		Cash2 = {
			NodeName = "Cash2",
			ProductId = 3572205537,
			PriceRobux = 49,
			CoinAmount = 1000000,
		},
		Cash3 = {
			NodeName = "Cash3",
			ProductId = 3572206027,
			PriceRobux = 399,
...
GameConfig.BRAINROT = {
	...
	WorldSpawnLandBarrierEnabled = false,
...
GameConfig.DEFAULT_PLAYER_DATA = {
	...
	ShopState = {
		VipOwned = false,
		ProcessedCashPurchaseIds = {},
		ProcessedServerLuckyPurchaseIds = {},
		ProcessedLuckyBlockPurchaseIds = {},
	},
	LeaderboardState = {
		TotalPlaySeconds = 0,
