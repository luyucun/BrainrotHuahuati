...
function RemoteEventService:Init()
    ...
    local eventDefinitions = {
        ...
        { Key = "RequestLuckyBlockOpen", Parent = systemEvents, Name = RemoteNames.System.RequestLuckyBlockOpen },
        { Key = "LuckyBlockFeedback", Parent = systemEvents, Name = RemoteNames.System.LuckyBlockFeedback },
