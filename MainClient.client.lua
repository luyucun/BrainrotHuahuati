...
local FavoritePlacePromptController = tryRequireControllerModule("FavoritePlacePromptController")
...
local brainrotBossController = startOptionalController(BrainrotBossController, modalController)
...
local favoritePlacePromptController = startOptionalController(FavoritePlacePromptController)
